...
type Category = GalleryCategory | ShopCategory;
interface Result {
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li tabIndex={0}>
              <Link className="justify-between" href={`/forum/`}>
                Forum
              </Link>
            </li>
            ...
            <li tabIndex={2}>
              ...
              <ul className="p-2 bg-neutral">
                {shop &&
                  shop.length > 0 &&
                  shop.map((cat: Category, index: number) => (
                    <li key={index}>
                      <Link href={`/shop/category/${cat.id}/${cat.slug}/`}>
                        {cat.name}
                      </Link>
                    </li>
                  ))}
